...
public class InputData {
    ...
    @SerializedName("STDs_cervical_condylomatosis")
    ...
    @SerializedName("STDs_pelvic_inflammatory_disease")
    ...
    @SerializedName("STDs_AIDS")
    private int stdsAIDS;
    @SerializedName("STDs_HIV")
    private int stdsHIV;
    @SerializedName("STDs_Hepatitis_B")
    ...
    @SerializedName("STDs_time_since_first_diagnosis")
    private int stdsTimeSinceFirstDiagnosis;
    @SerializedName("STDs_time_since_last_diagnosis")
