...
//        if (currentUser != null) {
//            // User is authenticated, set the email field
//            String userEmail = currentUser.getEmail();
//            if (userEmail != null) {
//                userEmailFeild.setText(userEmail);
//            } else {
//                // Handle the case when the email is null (optional)
//                userEmailFeild.setText("Unknown Email");
//            }
//        } else {
//            // Handle the case when there is no authenticated user (optional)
//            userEmailFeild.setText("Not Logged In");
//        }
//
//        uploadBtn.setOnClickListener(new View.OnClickListener() {
//            @Override
